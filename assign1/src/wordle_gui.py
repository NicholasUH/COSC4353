...
class WordleGui:
    ...
    def draw_lose_message(self):
        ...
        self.result_text = font.render("It was FAVOR, better luck next time", True, Color.BLACK.value)
        self.game_over = True
        


    def handle_wordle_logic(self):
        result = play_wordle("FAVOR", "".join(self.guesses[self.attempt.value]), self.attempt)
